...
#### Run the file autism_tweet_merge.ipynb, after running the first session will get the cleaned and pre-processed datasets with sentiment scores, and the second session will lead to the final datasets for user-interaction networks and the images for hashtags distributions.
